    ...
    <main>
        ...
        <div class="container margin_60">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="review_strip">
                        <img src="<?php echo SNTH_IMAGES_URL ?>/samples/avatar1.jpg" alt="Image" class="rounded-circle">
                        <h4>Jhon Doe</h4>
                        <p>
                ...
                <div class="col-lg-6">
                    <div class="review_strip">
                        <img src="<?php echo SNTH_IMAGES_URL ?>/samples/avatar2.jpg" alt="Image" class="rounded-circle">
                        <h4>Frank Rosso</h4>
                        <p>
                            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a lorem quis neque interdum consequat ut sed sem. Duis quis tempor nunc. Interdum et malesuada fames ac ante ipsum primis in faucibus."
                        </p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="review_strip">
                        <img src="<?php echo SNTH_IMAGES_URL ?>/samples/avatar3.jpg" alt="Image" class="rounded-circle">
                        <h4>Marc twain</h4>
                        <p>
                            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed a lorem quis neque interdum consequat ut sed sem. Duis quis tempor nunc. Interdum et malesuada fames ac ante ipsum primis in faucibus."
                        </p>
            ...
            <div class="row">
                <div class="col-md-6">
                    <img src="<?php echo SNTH_IMAGES_URL ?>/samples/laptop.png" alt="Laptop" class="img-fluid laptop">
                </div>
                <div class="col-md-6">
