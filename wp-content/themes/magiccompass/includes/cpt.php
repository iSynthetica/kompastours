...
function snth_excursion_cpt() {

    $labels = array(
        'name'                  => _x( 'Excursions', 'Post Type General Name', 'snthwp' ),
        'singular_name'         => _x( 'Excursion', 'Post Type Singular Name', 'snthwp' ),
        'menu_name'             => __( 'Excursions', 'snthwp' ),
        'name_admin_bar'        => __( 'Excursion', 'snthwp' ),
        'archives'              => __( 'Excursion Archives', 'snthwp' ),
        'attributes'            => __( 'Excursion Attributes', 'snthwp' ),
        'parent_item_colon'     => __( 'Parent Excursion:', 'snthwp' ),
        'all_items'             => __( 'All Excursions', 'snthwp' ),
        'add_new_item'          => __( 'Add New Excursion', 'snthwp' ),
        'add_new'               => __( 'Add New', 'snthwp' ),
        'new_item'              => __( 'New Excursion', 'snthwp' ),
        'edit_item'             => __( 'Edit Excursion', 'snthwp' ),
        'update_item'           => __( 'Update Excursion', 'snthwp' ),
        'view_item'             => __( 'View Excursion', 'snthwp' ),
        'view_items'            => __( 'View Excursions', 'snthwp' ),
        'search_items'          => __( 'Search Excursion', 'snthwp' ),
        'not_found'             => __( 'Not found', 'snthwp' ),
        'not_found_in_trash'    => __( 'Not found in Trash', 'snthwp' ),
        'featured_image'        => __( 'Featured Image', 'snthwp' ),
        'set_featured_image'    => __( 'Set featured image', 'snthwp' ),
        'remove_featured_image' => __( 'Remove featured image', 'snthwp' ),
        'use_featured_image'    => __( 'Use as featured image', 'snthwp' ),
        'insert_into_item'      => __( 'Insert into Excursion', 'snthwp' ),
        'uploaded_to_this_item' => __( 'Uploaded to this Excursion', 'snthwp' ),
        'items_list'            => __( 'Excursions list', 'snthwp' ),
        'items_list_navigation' => __( 'Excursions list navigation', 'snthwp' ),
        'filter_items_list'     => __( 'Filter Excursions list', 'snthwp' ),
    );
    $args = array(
        'label'                 => __( 'Excursion', 'snthwp' ),
        'description'           => __( 'Excursion Post Type', 'snthwp' ),
        'labels'                => $labels,
...
add_action( 'init', 'snth_excursion_cpt', 0 );
