...
function snth_ajax_send_testimonial() {
    $form_data_array = array (
        'clientName' => '',
        'clientEmail' => '',
        'clientPhone' => '',
    ...
    snth_create_testimonial($form_data_array);
    ...
    $subject = __('New client testimonial on your site', 'snthwp');
...
add_action('wp_ajax_nopriv_snth_ajax_send_testimonial', 'snth_ajax_send_testimonial');
add_action('wp_ajax_snth_ajax_send_testimonial', 'snth_ajax_send_testimonial');