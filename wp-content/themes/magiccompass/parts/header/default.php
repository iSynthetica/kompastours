    ...
    <div id="header-wrap">
        ...
        <div class="container">
            <div class="row">
                <div class="col-3">
                    <div id="logo">
                        <a href="index.html"><img src="<?php echo SNTH_IMAGES_URL ?>/samples/logo.png" width="160"
                                                  height="34" alt="City tours" data-retina="true"
                                                  class="logo_normal"></a>
                        <a href="index.html"><img src="<?php echo SNTH_IMAGES_URL ?>/samples/logo_sticky.png"
                ...
                <nav class="col-9">
                    ...
                    <div class="main-menu">
                        <div id="header_menu">
                            <img src="<?php echo SNTH_IMAGES_URL ?>/samples/logo_sticky.png" width="160" height="34" alt="City tours" data-retina="true">
                        </div>
                        ...
                        <li>
                            <div class="dropdown dropdown-cart">
                                ...
                                <ul class="dropdown-menu" id="cart_items">
                                    <li>
                                        <div class="image"><img src="<?php echo SNTH_IMAGES_URL ?>/samples/thumb_cart_1.jpg" alt="image"></div>
                                        <strong><a href="#">Louvre museum</a>1x $36.00 </strong>
                                        <a href="#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
                                        <div class="image"><img src="<?php echo SNTH_IMAGES_URL ?>/samples/thumb_cart_2.jpg" alt="image"></div>
                                        <strong><a href="#">Versailles tour</a>2x $36.00 </strong>
                                        <a href="#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
                                        <div class="image"><img src="<?php echo SNTH_IMAGES_URL ?>/samples/thumb_cart_3.jpg" alt="image"></div>
