                    ...
                    <tr>
                        <td>
                            <div class="section-title"
                                 style="color:#2c2c2c; font-family:Arial,sans-serif; font-size:16px; line-height:24px; text-align:left; text-transform:uppercase">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="img" style="font-size:0pt; line-height:0pt; text-align:left" bgcolor="#ff5e56" height="3">&nbsp;
                                    </td>
                                </tr>
                            </table>
