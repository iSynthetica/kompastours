    ...
    <div id="booking-form__container">
        <div id="booking-form__body">
            <form action="" id="booking-form">
                <?php ittour_show_template('single-tour/book-tour-form-hidden-fields.php', array(
                    'tour_info' => $tour_info,
                )) ?>
                ...
                <div id="booking-form__content">
                    <div id="booking-details__holder">
                            ...
                            <div class="row">
                                ...
                                if (!empty($tour_info["adult_amount"])) {
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <strong class="font-alt"><?php echo $tour_info["adult_amount"] ?></strong>
                                    </div>
                                    <?php
                                }
                                ...
                                if (!empty($tour_info["child_amount"])) {
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <strong class="font-alt"><?php echo $tour_info["child_amount"] ?></strong>
                                    </div>
                                    <?php
                                }
                        ...
                        if (!empty($tour_info["flights"]["from"]) || !empty($tour_info["flights"]["to"])) {
                            ...
                            <div class="tour-flights-list mb-20 prl-5 prl-md-10 prl-lg-20">
                                <div class="row">
                                    <?php
